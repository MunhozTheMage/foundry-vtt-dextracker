    ...
    ***************************************************************************** */
    ...
    class Creatures {
        ...
        importFromObject(data, { overwrite = true } = {}) {
            return __awaiter$4(this, void 0, void 0, function* () {
                const currentData = yield this.getCreatures();
        ...
        getPaginatedCreatures(amountPerPage = 15) {
            return __awaiter$4(this, void 0, void 0, function* () {
                const { creatures } = yield this.getCreatures();
                const pages = Math.ceil(creatures.length / amountPerPage);
                const paginatedCreatures = times((i) => range(i * amountPerPage, i * amountPerPage + amountPerPage).map((i) => creatures[i]), pages);
                return {
                    pages,
                    paginatedCreatures,
                };
        ...
        _createFileIfNotPresent() {
            return __awaiter$4(this, void 0, void 0, function* () {
                ...
                yield this.uploader.upload(defaultData);
            });
        }
    }
    ...
    class DexApplication extends Application {
        constructor() {
            super();
        }
        static get defaultOptions() {
        ...
        getData() {
            ...
            return __awaiter$1(this, void 0, void 0, function* () {
                const creatures = (yield Data.CreaturesData.getCreatures()).creatures;
                return {
                    user: {
                    ...
                    creatures: creatures.map((creature) => (Object.assign(Object.assign({}, creature), { status: {
                            type: MOCK_Status,
                            text: { "not-seen": "Not seen", seen: "Seen", caught: "Caught" }[MOCK_Status],
                        } }))),
                };
            });
        }
